#ifndef MCMD_MC_SPECIES_COUNT_H
#define MCMD_MC_SPECIES_COUNT_H
...
namespace McMd
{
   ...
   */
   class McSpeciesCount : public SystemAnalyzer<McSystem>
   {
   ...
   public:
      ...
      */
      McSpeciesCount(McSystem& system);
   ...
   */
   template <class Archive>
   void McSpeciesCount::serialize(Archive& ar, const unsigned int version)
